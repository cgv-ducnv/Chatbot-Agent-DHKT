...
interface DocumentDataTablePaginationProps<TData> {
  table: Table<TData>;
  pagination?: {
    total: number;
    page: number;
...
export function DocumentDataTablePagination<TData>({
  table,
  pagination,
  currentPage = 1,
  currentPageSize = 10,
  ...
  return (
    <div className="flex items-center justify-between px-4">
      <div className="text-muted-foreground hidden flex-1 text-sm lg:flex">
        {table.getFilteredSelectedRowModel().rows.length} tài liệu được chọn.
      </div>
      <div className="flex w-full items-center gap-8 lg:w-fit">
        <div className="hidden items-center gap-2 lg:flex">
          <Label htmlFor="doc-rows-per-page" className="text-sm font-medium">
