  ...
  "modern-minimal": {
    ...
    styles: {
      light: {
        ...
        secondary: "#f3f4f6",
        "secondary-foreground": "#2d2d2eff",
        muted: "#f9fafb",
        "muted-foreground": "#0b0b0bff",
        accent: "#e0f2fe",
        ...
        radius: "0.375rem",
        sidebar:
          "linear-gradient(135deg, #91dbfdff 0%, #3c86fcff 45%, #5bc5ffff 75%, #b9dff7ff 100%)",
      ...
      dark: {
        ...
        "chart-5": "#1e40af",
        radius: "0.375rem",
        sidebar: "linear-gradient(180deg, #0f172a 0%, #1e3a8a 100%)",
